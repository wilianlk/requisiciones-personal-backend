...
namespace BackendRequisicionPersonal.Models
{
    ...
    {
        // ===== Campos REQUERIDOS por negocio (coinciden con el front) =====
        ...
        public bool RequiereMoto { get; set; } // el front siempre manda (true/false)
        ...
        // Estado/fechas del flujo (el servicio los completa si vienen nulos)
